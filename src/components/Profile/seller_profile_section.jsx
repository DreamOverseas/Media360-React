    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-3 sm:p-6">
      <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-lg sm:text-2xl lg:text-3xl font-bold text-gray-800 mb-2">
            {t("profile.page.sellerDetail.title")}
          </h2>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <h3 className="text-base sm:text-xl lg:text-2xl font-bold text-white">
                {t("profile.page.sellerDetail.basicInfo")}
              </h3>
            </div>
          </div>
          ...
          <div className="p-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
              ...
              <div className="space-y-4 sm:space-y-5 lg:space-y-6">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-blue-100 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                    <Building2 className="text-blue-600 w-4 h-4 lg:w-5 lg:h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className="block text-xs sm:text-sm font-medium text-gray-500 mb-1">
                      {t("profile.page.sellerDetail.companyName")}
                    </span>
                    <span className="text-sm sm:text-base lg:text-lg font-semibold text-gray-800 break-words">
                      {companyName}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-green-100 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                    <Tag className="text-green-600 w-4 h-4 lg:w-5 lg:h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className="block text-xs sm:text-sm font-medium text-gray-500 mb-1">
                      {t("profile.page.sellerDetail.industry")}
                    </span>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-purple-100 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                    <MapPin className="text-purple-600 w-4 h-4 lg:w-5 lg:h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className="block text-xs sm:text-sm font-medium text-gray-500 mb-1">
                      {t("profile.page.sellerDetail.address")}
                    </span>
                    <span className="text-sm sm:text-base lg:text-lg font-semibold text-gray-800 break-words">
                      {address}
                    </span>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-red-100 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                    <Hash className="text-red-600 w-4 h-4 lg:w-5 lg:h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className="block text-xs sm:text-sm font-medium text-gray-500 mb-1">
                      {t("profile.page.sellerDetail.abn")}
                    </span>
              ...
              <div className="space-y-4 sm:space-y-5 lg:space-y-6">
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-blue-100 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                    <Mail className="text-blue-600 w-4 h-4 lg:w-5 lg:h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className="block text-xs sm:text-sm font-medium text-gray-500 mb-1">
                      {t("profile.page.sellerDetail.email")}
                    </span>
                    {contactEmail !== "—" ? (
                      <a
                        href={`mailto:${contactEmail}`}
                        className="text-sm sm:text-base lg:text-lg font-semibold text-blue-600 hover:text-blue-700 underline decoration-dotted"
                      >
                        {contactEmail}
                      </a>
                    ) : (
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-green-100 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                    <Phone className="text-green-600 w-4 h-4 lg:w-5 lg:h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className="block text-xs sm:text-sm font-medium text-gray-500 mb-1">
                      {t("profile.page.sellerDetail.phone")}
                    </span>
                ...
                <div className="flex items-start space-x-3 sm:space-x-4">
                  <div className="bg-indigo-100 p-1.5 sm:p-2 rounded-lg flex-shrink-0">
                    <Globe className="text-indigo-600 w-4 h-4 lg:w-5 lg:h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className="block text-xs sm:text-sm font-medium text-gray-500 mb-1">
                      {t("profile.page.sellerDetail.website")}
                    </span>
                    {website ? (
                      <a
                        href={website}
                        ...
                        className="text-sm sm:text-base lg:text-lg font-semibold text-indigo-600 hover:text-indigo-700 underline decoration-dotted"
                      >
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-orange-500 to-red-500 px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6">
            <div className="flex items-center space-x-2 sm:space-x-3">
              ...
              <h3 className="text-base sm:text-xl lg:text-2xl font-bold text-white">
                {t("profile.page.sellerDetail.campaignPrefs")}
              </h3>
            </div>
          </div>
            ...
            {campaigns.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 text-sm sm:text-base">
                  {t("profile.page.sellerDetail.noCampaigns")}
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                {campaigns.map((c, idx) => {
                  const title = c.title || c.name || t("profile.page.sellerDetail.untitledCampaign");
                  const type = c.type || c.category || "—";
                  const description = c.description || c.desc || "—";
                  const requirement = c.requirement || c.requirements || "—";
                  const validUntil = c.valid_until || c.validUntil || c.expires_at || "—";
                  return (
                    <div key={idx} className="group relative bg-gradient-to-br from-orange-50 to-red-50 rounded-xl p-4 border-2 border-orange-100 hover:border-orange-200 transition-all duration-300">
                      <h4 className="font-bold text-sm sm:text-lg text-gray-800 group-hover:text-orange-700 transition-colors">
                        {title}
                      </h4>
                      <span className="px-2 py-0.5 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-full text-xs font-medium shadow-sm">
                        {type}
                      </span>

                      <div className="mt-3 space-y-2">
                        <div className="bg-white/70 rounded-lg p-2 border border-orange-100">
                          <span className="text-xs sm:text-sm text-gray-700 leading-relaxed">{description}</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center space-x-2">
                          <span className="text-xs font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded w-fit">
                            {t("profile.page.sellerDetail.requirement")}
                          </span>
                          <span className="text-xs sm:text-sm text-gray-600">{requirement}</span>
                        </div>

                        <div className="flex flex-col sm:flex-row sm:items-center space-x-2">
                          <span className="text-xs font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded w-fit">
                            {t("profile.page.sellerDetail.validUntil")}
                          </span>
                          <span className="text-xs sm:text-sm text-gray-600">{validUntil}</span>
                        </div>
                      </div>
                    </div>
                  );
      ...
      <button
        ...
        className="mt-4 rounded flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 sm:px-5 sm:py-2 font-medium transition-colors w-full sm:w-auto max-w-[300px]"
      >
        {t("profile.page.sellerDetail.contactUsBtn")}
      </button>
      <p>{t("profile.page.sellerDetail.contactUsNote")}</p>
    </div>
  );
};
