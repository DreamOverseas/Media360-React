  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        if (
          (countryCode === "CN" && Product?.BlockInChina && Product?.MainCollectionProduct) ||
          (countryCode === "CN" && Product?.BlockInChina && Product?.SingleProduct && !Product?.MainCollectionProduct)
        ) {
          return navigate("/", { replace: true });
        }
        if (
          countryCode === "CN" &&
          !Product?.BlockInChina &&
